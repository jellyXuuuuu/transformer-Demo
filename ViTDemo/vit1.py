...
'''
train_parameters = {
    "input_size": [3, 120, 120],   
    "class_dim": 3,          
    "src_path":"/home/flyslice/xy/test/transformer-Demo/ViTDemo/data/Data.zip",     #原始数据集路径
    "target_path":"/home/flyslice/xy/test/transformer-Demo/ViTDemo/work/",                    #要解压的路径
    "train_list_path": "/home/flyslice/xy/test/transformer-Demo/ViTDemo/data/train.txt",      #train.txt路径
    "eval_list_path": "/home/flyslice/xy/test/transformer-Demo/ViTDemo/data/eval.txt",        #eval.txt路径
    ...
    "checkpoints": "/home/flyslice/xy/test/transformer-Demo/ViTDemo/work/checkpoints"         #保存的路径
...
#查看数据
path1='/home/flyslice/xy/test/transformer-Demo/ViTDemo/Data/1_96.png'
path2='/home/flyslice/xy/test/transformer-Demo/ViTDemo/Data/2_832.png'
path3='/home/flyslice/xy/test/transformer-Demo/ViTDemo/Data/3_1398.png'
# # 汽车
...
#训练数据加载
train_dataset = dataset('/home/flyslice/xy/test/transformer-Demo/ViTDemo/data',mode='train')
train_loader = paddle.io.DataLoader(train_dataset, 
                                    batch_size=train_parameters['train_batch_size'], 
                                    shuffle=True
                                    )
#测试数据加载
eval_dataset = dataset('/home/flyslice/xy/test/transformer-Demo/ViTDemo/data',mode='eval')
...
for epo in range(train_parameters['num_epochs']):
    for _, data in enumerate(train_loader()):
        ...
        if steps % train_parameters["skip_steps"] == 0:
            ...
            total_loss.append(float(acc))
            #打印中间过程
            print('epo: {}, step: {}, loss is: {}, acc is: {}'\
                  .format(epo, steps, float(loss), float(acc)))
        #保存模型参数
